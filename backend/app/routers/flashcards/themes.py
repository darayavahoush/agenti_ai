...
THEMES = {
    ...
    "birds":             {"name": "Birds",              "emoji": "🐦", "words": ["bird","parrot","duck"]},
    "sea_animals":       {"name": "Sea Animals",        "emoji": "🐬", "words": ["octopus","shark","dolphin","whale","crab","fish"]},
    ...
    "school_supplies":   {"name": "School Supplies",    "emoji": "✏", "words": ["pen","pencil","paper","book","bag"]},
    "music":             {"name": "Music",              "emoji": "🎸", "words": ["guitar","piano","drum","trumpet","violin"]},
    "community_helpers": {"name": "Community Helpers",  "emoji": "👩", "words": ["teacher","doctor","police","firefighter","farmer"]},
    "living_room":       {"name": "Living Room",        "emoji": "🛋", "words": ["chair","table","window","door"]},
    "bedroom":           {"name": "Bedroom",            "emoji": "🛏", "words": ["bed","lamp","clock","teddybear"]},
