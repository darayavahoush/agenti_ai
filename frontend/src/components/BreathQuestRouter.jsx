...
export default function BreathQuestRouter() {
  return (
    <AuthProvider>
      <a
        href="/?page=therapy"
        className="fixed top-4 right-4 z-50 rounded-full border border-white/20 bg-brand-dark/90 px-4 py-2 text-sm font-semibold text-white shadow-lg backdrop-blur transition-colors hover:border-brand-green hover:text-brand-green"
