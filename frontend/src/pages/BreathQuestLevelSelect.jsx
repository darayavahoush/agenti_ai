...
import { useBreathQuestAuth } from '../context/BreathQuestAuth'
import { Avatar } from '../components/BreathQuestUI/ui'
...
export default function BreathQuestLevelSelect() {
  const { patient, logout } = useBreathQuestAuth()
