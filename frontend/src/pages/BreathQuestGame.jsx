...
import { BreathEngine } from '../breathquest/game/engine/BreathEngine.js'
import { LEVEL_FACTORIES, LEVEL_META } from '../breathquest/game/index.js'
import { calcStars, saveScore, loadScores, isUnlocked, LEVEL_ORDER } from '../breathquest/game/scoring/index.js'

const W = 800, H = 580

export default function BreathQuestGame({ setPage, breathquestLevel, setBreathquestLevel }) {
  const levelId = breathquestLevel
  ...
  return (
    <div className="min-h-screen flex flex-col bg-brand-dark">
      ...
      <div className="flex items-center justify-between px-5 py-3 border-b border-white/10 flex-shrink-0">
        <button onClick={() => { cleanup(); setPage('breathquest') }}
            ...
            <div className="flex flex-col items-center justify-center text-center py-16 rounded-2xl"
              ...
              {!unlocked ? (
                <div className="mt-6 text-center">
                  ...
                  <button onClick={() => setPage('breathquest')}
          ...
          {phase === 'complete' && result && (
            <div className="flex flex-col items-center justify-center text-center py-10 rounded-2xl relative overflow-hidden"
              ...
              <div className="flex gap-3 flex-wrap justify-center">
                ...
                {nextId && (
                  <button onClick={() => { cleanup(); setBreathquestLevel(nextId); setPage('breathquest-game') }}
