...
import { loadScores, isUnlocked, LEVEL_ORDER, DIFFICULTY } from '../breathquest/game/scoring/index.js'
...
export default function BreathQuest({ setPage, setBreathquestLevel }) {
  ...
  return (
    <div className="min-h-screen" style={{
      ...
      <div className="flex items-center justify-between px-6 py-4 border-b border-white/10">
        <button onClick={() => setPage('therapy')} 
        ...
        <div className="text-white/30 text-sm">BreathQuest</div>
      </div>
      ...
      <div className="max-w-3xl mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-2 gap-4">
          {LEVELS.map((level, i) => {
            ...
            return (
              <button key={level.id}
                onClick={() => { if (unlocked) { setBreathquestLevel(level.id); setPage('breathquest-game') } }}
