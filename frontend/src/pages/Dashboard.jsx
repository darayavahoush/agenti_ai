    ...
    <div style={{ padding: "24px", background: "#f8fafc", minHeight: "calc(100vh - 80px)" }}>
      ...
      {loading ? (
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
          ...
          >
            <div className="card" style={{ padding: "20px", background: "white", borderRadius: "16px", boxShadow: "0 4px 12px rgba(0,0,0,0.05)", borderLeft: "6px solid #8b5cf6" }}>
            ...
            <div className="card" style={{ padding: "20px", background: "white", borderRadius: "16px", boxShadow: "0 4px 12px rgba(0,0,0,0.05)", borderLeft: "6px solid #0ea5e9" }}>
            ...
            <div className="card" style={{ padding: "20px", background: "white", borderRadius: "16px", boxShadow: "0 4px 12px rgba(0,0,0,0.05)", borderLeft: "6px solid #22c55e" }}>
